  ...
  getFilteredData: vi.fn().mockResolvedValue([
    {
      ...
      operationalCommand: {
        id: 1,
        stateId: 1,
        nomenclature: "Diretoria de Planejamento Operacional / Diretoria Operacional Especializada",
        acronym: "DPO/DOE",
        subdivisions: "Coordenadoria de Operações; Coordenadoria de Doutrina",
        attributions: "Planejar e coordenar as atividades operacionais",
        detailLevel: "detalhado",
        legalBasis: "Minuta de Lei de Organização Básica do CBMRO",
        notes: null,
      },
      technicalDirectorate: {
        id: 1,
        stateId: 1,
        nomenclature: "Comando de Operações Técnicas / Coordenadorias de Atividades Técnicas",
        acronym: "COT/CAT",
        subdivisions: "Seção de Estudos Técnicos; Seção de Planejamento Técnico",
        attributions: "Planejar e coordenar as atividades técnicas",
        detailLevel: "detalhado",
        legalBasis: "Minuta de Lei de Organização Básica do CBMRO",
        notes: null,
      },
