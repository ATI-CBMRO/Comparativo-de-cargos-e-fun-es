...
"rs": {
  ...
  "organs": {
    ...
    "cg-rs-lob": {
      ...
      "subordinadoA": "Secretaria da Segurança Pública", "legalRef": "Art. 3º, 4º e 5º",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 3º (Estrutura do CBMRS)", "Art. 4º (Comando-Geral)", "Art. 5º (Competência do Comandante-Geral)"],
      "atribuicoes": [
      ...
      "desdobramentos": ["Gabinete do Comando-Geral", "Corregedoria-Geral", "Comissão de Avaliação e Mérito", "Conselho Superior", "Departamento Administrativo", "Departamento de Segurança, Prevenção e Proteção Contra Incêndios", "Academia de Bombeiro Militar", "Comando Regional de Bombeiro Militar Metropolitano – Porto Alegre", "Comando Regional de Bombeiro Militar do Interior – Santa Maria"],
      "cargos": []
    },
    "scg-rs-lob": {
      "name": "Subcomandante-Geral", "abbreviation": "SCG", "category": "Direção Geral", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 7º",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 7º (Subcomandante-Geral)"],
      "atribuicoes": [
        "O Subcomandante-Geral é o substituto imediato do Comandante-Geral nos impedimentos eventuais deste, competindo-lhe, igualmente, as funções que lhe forem delegadas pelo Comandante-Geral (Art. 7º)."
      ],
      "desdobramentos": [],
      "cargos": []
    },
    "gab-rs-lob": {
      "name": "Gabinete do Comando-Geral", "abbreviation": "GCG", "category": "Apoio", "source": "lob",
      "subordinadoA": "Comando-Geral", "legalRef": "Art. 3º, I e Art. 6º",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 3º, I (composição do Gabinete)", "Art. 6º (competência)"],
      "atribuicoes": [
        "Ao Gabinete do Comando-Geral compete a assistência e o assessoramento direto ao Comandante-Geral e ao Subcomandante-Geral (Art. 6º)."
      ],
      "desdobramentos": ["Secretaria Executiva do Comandante-Geral", "Secretaria Executiva do Subcomandante-Geral", "Assessoria Jurídica, Convênios e Contratos", "Assessoria de Comunicação Social e Parlamentar", "Assessoria de Operações e Defesa Civil"],
      "cargos": []
    },
    "cs-rs-lob": {
      "name": "Conselho Superior", "abbreviation": "CS", "category": "Apoio", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 3º, IV e Art. 8º",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 8º (Conselho Superior)"],
      "atribuicoes": [
        "O Conselho Superior é constituído pelos Coronéis da ativa em exercício na Corporação, competindo-lhe, em assessoramento direto ao Comandante-Geral, o acompanhamento e a manifestação em assuntos relevantes da Instituição, com vista ao fornecimento de subsídios para a tomada de decisão (Art. 8º)."
      ],
      "desdobramentos": [],
      "cargos": []
    },
    "corg-rs-lob": {
      "name": "Corregedoria-Geral", "abbreviation": "Corr-G", "category": "Apoio", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 3º, II e Art. 9º",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 9º (Corregedoria-Geral)"],
      "atribuicoes": [
        "A Corregedoria-Geral, órgão de disciplina, de orientação e de fiscalização das atividades funcionais e da conduta dos militares e dos servidores civis da Instituição, subordina-se diretamente ao Comandante-Geral (Art. 9º)."
      ],
      "desdobramentos": [],
      "cargos": []
    },
    "cam-rs-lob": {
      "name": "Comissão de Avaliação e Mérito", "abbreviation": "CAM", "category": "Apoio", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 3º, III e Art. 10",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 10 (Comissão de Avaliação e de Mérito)"],
      "atribuicoes": [
        "À Comissão de Avaliação e de Mérito, órgão permanente de assessoramento do Comandante-Geral nos assuntos relativos às carreiras de Oficiais e de Praças da Instituição, compete o controle, a avaliação e o processamento das promoções (Art. 10)."
      ],
      "desdobramentos": [],
      "cargos": []
    },
    "da-rs-lob": {
      "name": "Departamento Administrativo", "abbreviation": "DA", "category": "Apoio", "source": "lob",
      "subordinadoA": "Comando-Geral", "legalRef": "Art. 3º, V, Art. 11 e Art. 12",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 11 (Órgãos de apoio)", "Art. 12 (Departamento Administrativo)"],
      "atribuicoes": [
        "Os Órgãos de apoio do CBMRS são constituídos pelos Departamentos e pela Academia de Bombeiro Militar, subordinados ao Comando-Geral, competindo-lhes o planejamento, a direção, o controle e a execução das diretrizes emanadas do comando da Instituição (Art. 11).",
        "O Departamento Administrativo é o responsável pelo planejamento, controle, fiscalização, auditoria e execução das atividades relacionadas a recursos humanos, orçamento e finanças, logística e patrimônio e tecnologia da informação e comunicações (Art. 12)."
      ],
      "desdobramentos": ["Divisão Administrativa", "Divisão de Logística e Patrimônio", "Divisão de Orçamento e Finanças", "Divisão de Recursos Humanos", "Divisão de Tecnologia da Informação e Comunicações"],
      "cargos": []
    },
    "dspci-rs-lob": {
      "name": "Departamento de Segurança, Prevenção e Proteção Contra Incêndios", "abbreviation": "DSPCI", "category": "Apoio", "source": "lob",
      "subordinadoA": "Comando-Geral", "legalRef": "Art. 3º, VI e Art. 13",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 13 (Departamento de Segurança, Prevenção e Proteção Contra Incêndios)"],
      "atribuicoes": [
        "O Departamento de Segurança, Prevenção e Proteção Contra Incêndios é o órgão de planejamento, controle e fiscalização das atividades relacionadas à segurança contra incêndios e à investigação de sinistros em âmbito estadual (Art. 13)."
      ],
      "desdobramentos": ["Divisão Administrativa", "Divisão de Gestão e Normatização", "Divisão de Pesquisa e Investigação de Sinistros"],
      "cargos": []
    },
    "abm-rs-lob": {
      "name": "Academia de Bombeiro Militar", "abbreviation": "ABM", "category": "Apoio", "source": "lob",
      "subordinadoA": "Comando-Geral", "legalRef": "Art. 3º, VII e Art. 14",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 14 (Academia de Bombeiro Militar)"],
      "atribuicoes": [
        "A Academia de Bombeiro Militar é o órgão responsável pelo planejamento, controle e fiscalização das atividades relacionadas ao ensino, à saúde física do efetivo e à pesquisa científica da Instituição, bem como pela capacitação continuada dos servidores e dos profissionais civis que exerçam atividade auxiliar de bombeiro em âmbito estadual (Art. 14)."
      ],
      "desdobramentos": ["Divisão de Ensino", "Divisão Administrativa", "Órgão de Pesquisa, Ensino, Treinamento e Avaliação"],
      "cargos": []
    },
    "crbm-rs-lob": {
      "name": "Comandos Regionais de Bombeiro Militar", "abbreviation": "CRBM", "category": "Execução", "source": "lob",
      "subordinadoA": "Comando-Geral", "legalRef": "Art. 3º, VIII e IX, Art. 15 e Art. 16",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 15 (Comandos Regionais de Bombeiro Militar)", "Art. 16 (Circunscrições Territoriais)"],
      "atribuicoes": [
        "Os Comandos Regionais de Bombeiro Militar, escalões intermediários de comando, com nível de Órgãos de Apoio, são os responsáveis, em suas respectivas circunscrições territoriais, pelas atividades administrativo-operacionais dos Órgãos de Bombeiro Militar – OBM, que lhe são subordinados (Art. 15).",
        "As Circunscrições Territoriais dos Comandos Regionais e as respectivas Áreas de Atuação Territoriais serão definidas por Portaria do Comandante-Geral do CBMRS (Art. 16)."
      ],
      "desdobramentos": ["Comando Regional de Bombeiro Militar Metropolitano – Porto Alegre (1º, 2º, 8º e 9º BBM e Companhia Especial de Busca e Salvamento)", "Comando Regional de Bombeiro Militar do Interior – Santa Maria (3º, 4º, 5º, 6º, 7º, 10º, 11º e 12º BBM)"],
      "cargos": []
    },
    "obm-rs-lob": {
      "name": "Órgãos de Bombeiro Militar (OBM)", "abbreviation": "OBM", "category": "Execução", "source": "lob",
      "subordinadoA": "Comandos Regionais de Bombeiro Militar / Academia de Bombeiro Militar", "legalRef": "Art. 17 a 21",
      "baseLegal": "Decreto nº 53.897, de 25 de janeiro de 2018, que regulamenta a Lei Complementar nº 14.920, de 1º de agosto de 2016 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 17 (Classificação dos OBM)", "Art. 18 (Competência dos OBM de Segurança, Proteção, Prevenção e Combate a Incêndios)", "Art. 20 (Níveis dos OBM)", "Art. 21 (OBM de Ensino)"],
      "atribuicoes": [
        "Os OBM, responsáveis pela execução das atividades administrativo-operacionais indispensáveis ao cumprimento das finalidades da Instituição, são classificados em: de Segurança, de Proteção, de Prevenção e de Combate a Incêndios, de Ensino e Especiais (Art. 17).",
        "Aos OBM de Segurança, de Proteção, de Prevenção e de Combate a Incêndios compete a execução das atividades de bombeiros e de defesa civil, no âmbito de seu espaço de responsabilidade territorial, respondendo perante o Comando Regional de Bombeiros pela realização de suas atividades na correspondente circunscrição (Art. 18).",
        "Os OBM de Ensino, responsáveis pela execução das atividades de ensino, de instrução, de treinamento, de avaliação e de pesquisa serão comandados e dirigidos por Oficiais Superiores (Art. 21)."
      ],
      "desdobramentos": ["Batalhão de Bombeiro Militar (BBM)", "Companhia de Bombeiro Militar (CiaBM)", "Companhia Especial de Bombeiro Militar (CEBM)", "Companhia Especial de Busca e Salvamento (CEBS)", "Pelotão de Bombeiro Militar (PelBM)", "Pelotão de Busca e Salvamento (PelBS)", "Pelotão Especial de Busca e Salvamento (PelEBS)", "Grupo de Bombeiro Militar (GBM) / Grupo de Busca e Salvamento (GBS)"],
      "cargos": []
    }
  }
},
...
"se": {
  ...
  "organs": {
    ...
    "cg-se-lob": {
      "name": "Comando-Geral", "abbreviation": "CG", "category": "Direção Estratégica", "source": "lob",
      "subordinadoA": "Governador do Estado", "legalRef": "Art. 5º a 9º",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 5º (Comando-Geral)", "Art. 6º (Comandante-Geral)", "Art. 7º (Atribuições)", "Art. 8º (Subcomandante-Geral)", "Art. 9º (Atribuições do Subcomandante-Geral)"],
      "atribuicoes": [
        "O Comando-Geral é órgão de Direção Estratégica do CBMSE, sendo responsável pela administração superior (comando), gestão, planejamento e condução estratégica da Corporação, compreendendo: I - Comandante-Geral; II - Subcomandante-Geral; III - Estado-Maior-Geral; IV - Gabinete; V - Corregedoria-Geral; VI - Controladoria Interna; VII - Ouvidoria-Geral; VIII - Assessorias; IX - Comissões Técnicas (Art. 5º)."
      ],
      "desdobramentos": ["Comandante-Geral", "Subcomandante-Geral", "Estado-Maior-Geral", "Gabinete", "Corregedoria-Geral", "Controladoria Interna", "Ouvidoria-Geral", "Assessorias", "Comissões Técnicas"],
      "cargos": []
    },
    "emg-se-lob": {
      "name": "Estado-Maior-Geral", "abbreviation": "EMG", "category": "Direção Estratégica", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 10",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 10 (Estado-Maior-Geral)"],
      "atribuicoes": [
        "O Estado-Maior-Geral é o órgão de direção estratégica, responsável perante o Comandante-Geral, pelo planejamento, orientação, coordenação, fiscalização e execução das atividades relacionadas à gestão administrativa, visando à eficácia da instituição no cumprimento de suas atribuições (Art. 10). Parágrafo Único. O Estado-Maior-Geral é composto pelos Chefe do Estado-Maior-Geral, Corregedor-Geral e titulares de diretorias do nível de direção-geral da Instituição."
      ],
      "desdobramentos": ["Chefe do Estado-Maior-Geral", "Corregedor-Geral", "Titulares de diretorias de nível de direção-geral"],
      "cargos": []
    },
    "gab-se-lob": {
      "name": "Gabinete do Comandante-Geral", "abbreviation": "GAB", "category": "Direção Estratégica", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 11 a 14",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 11 (Gabinete)", "Art. 12 (Chefia de Gabinete)", "Art. 13 (Ajudância de Ordens)", "Art. 14 (Ajudância-Geral)"],
      "atribuicoes": [
        "O Gabinete do Comandante-Geral, ao qual compete o assessoramento direto ao Comandante-Geral, é composto por: I - Chefia de Gabinete; II - Ajudância de Ordens; III - Ajudância-Geral (Art. 11).",
        "À Chefia de Gabinete compete o exercício das funções de assistência e assessoramento direto ao Comandante-Geral e ao Subcomandante-Geral, inerentes ao controle, coordenação e fiscalização das atividades administrativas desenvolvidas por militares e civis no âmbito dos Gabinetes do Comandante-Geral e do Subcomandante-Geral, da Ajudância de Ordens (Art. 12).",
        "À Ajudância de Ordens compete o assessoramento diário ao Comandante-Geral e ao Subcomandante-Geral, relacionado ao controle de agendas, bem como à recepção de autoridades, os controles no cumprimento de compromissos oficiais e fiscalização patrimonial dos materiais pertencentes aos Gabinetes do Comandante-Geral e do Subcomandante-Geral (Art. 13).",
        "À Ajudância-Geral compete a administração do Quartel do Comando-Geral, considerado como Organização Bombeiro Militar, bem como do expediente, da execução dos trabalhos de secretaria, incluindo a correspondência, correio, redação do boletim diário, do protocolo e arquivo geral e biblioteca, do apoio em pessoal aos órgãos que compõem o Comando-Geral, dos serviços gerais, do Centro de Memória e da segurança do Quartel do Comando-Geral (Art. 14)."
      ],
      "desdobramentos": ["Chefia de Gabinete", "Ajudância de Ordens", "Ajudância-Geral"],
      "cargos": []
    },
    "ass-se-lob": {
      "name": "Assessorias", "abbreviation": "ASS", "category": "Direção Estratégica", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 18",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 18 (Assessorias)"],
      "atribuicoes": [
        "As Assessorias são órgãos de assessoramento direto do Comando-Geral em assuntos específicos da Corporação (Art. 18, caput). § 1º As Assessorias de que trata o \"caput\" deste artigo compreendem: I - Assessoria Técnica de Engenharia e Arquitetura; II - Assessoria de Inteligência; III - Assessoria Técnica Institucional; IV - Assessoria de Comunicação; V - Assessoria de Tecnologia da Informação; VI - Assessoria Parlamentar."
      ],
      "desdobramentos": ["Assessoria Técnica de Engenharia e Arquitetura", "Assessoria de Inteligência", "Assessoria Técnica Institucional", "Assessoria de Comunicação", "Assessoria de Tecnologia da Informação", "Assessoria Parlamentar"],
      "cargos": []
    },
    "ct-se-lob": {
      "name": "Comissões Técnicas", "abbreviation": "CT", "category": "Direção Estratégica", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 19",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 19 (Comissões Técnicas)"],
      "atribuicoes": [
        "As Comissões Técnicas são órgãos permanentes ou temporários, instituídos por ato do Comandante-Geral, competindo-lhes a realização de estudos de caso, emissão de pareceres e elaboração de trabalhos específicos relacionados às atividades administrativas e operacionais no âmbito da instituição, inclusive em relação a assuntos como a especificação de materiais, viaturas, embarcações, instrumentos e equipamentos, desenvolvimento de software, programas e projetos institucionais (Art. 19)."
      ],
      "desdobramentos": [],
      "cargos": []
    },
    "altocomando-se-lob": {
      "name": "Alto-Comando", "abbreviation": "AC", "category": "Direção Colegiada", "source": "lob",
      "subordinadoA": "Comandante-Geral", "legalRef": "Art. 20",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 20 (Alto-Comando)"],
      "atribuicoes": [
        "O Alto-Comando do CBMSE é o Órgão Colegiado Superior da instituição, de caráter consultivo, necessário ao processo decisório compartilhado da gestão estratégica do Corpo de Bombeiros Militar, a partir da provocação do Comandante-Geral (Art. 20). § 3º Ao Alto-Comando compete: I - propor políticas de segurança pública, em particular na parcela constitucional que cabe ao Corpo de Bombeiros Militar, e apresentar soluções para o aperfeiçoamento do sistema; II - apresentar propostas e mudanças sobre matérias de cunho estratégico que promovam o aperfeiçoamento da instituição; III - submeter matérias de relevância, relativas à Corporação, à superior decisão governamental; IV - apresentar propostas que alterem a estrutura organizacional da instituição e outros assuntos do interesse da Corporação."
      ],
      "desdobramentos": [],
      "cargos": []
    },
    "cpocpp-se-lob": {
      "name": "Comissões de Promoção de Oficiais e Praças", "abbreviation": "CPO/CPP", "category": "Direção Colegiada", "source": "lob",
      "subordinadoA": "Comandante-Geral / Subcomandante-Geral", "legalRef": "Art. 21",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 21 (Comissões de Promoção de Oficiais e Praças)"],
      "atribuicoes": [
        "As Comissões de Promoção de Oficiais - CPO e de Praças - CPP são órgãos colegiados de processamento das promoções do CBMSE (Art. 21). Parágrafo Único. O colegiado da CPO deve ser presidido pelo Comandante-Geral e o colegiado da CPP deve ser presidido pelo Subcomandante-Geral."
      ],
      "desdobramentos": [],
      "cargos": []
    },
    "dg-se-lob": {
      "name": "Órgãos de Direção-Geral", "abbreviation": "DG", "category": "Direção Geral", "source": "lob",
      "subordinadoA": "Comandante-Geral / Subcomandante-Geral", "legalRef": "Art. 22 a 27",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 22 (Órgãos de Direção-Geral)", "Art. 23 (DLOG)", "Art. 24 (DFIN)", "Art. 25 (DGP)", "Art. 26 (DEP)", "Art. 27 (DPLAN)"],
      "atribuicoes": [
        "Os Órgãos de Direção-Geral são encarregados pelo assessoramento técnico e pela administração geral do CBMSE, incumbindo-lhes o planejamento, a coordenação, a execução, o controle e a fiscalização da organização, do suprimento de pessoal, de material e do emprego de subordinados ao Comandante-Geral e coordenados pelo Subcomandante-Geral (Art. 22). § 1º Os Órgãos de Direção-Geral compreendem as seguintes Diretorias: I - Diretoria de Logística - DLOG; II - Diretoria de Finanças - DFIN; III - Diretoria de Gestão de Pessoal - DGP; IV - Diretoria de Ensino e Pesquisa - DEP; V - Diretoria de Planejamento - DPLAN. § 2º As chefias dos Órgãos de Direção-Geral são privativas de oficiais da ativa do último posto do Quadro de Oficiais Bombeiro Militar - QOBM."
      ],
      "desdobramentos": ["Diretoria de Logística - DLOG", "Diretoria de Finanças - DFIN", "Diretoria de Gestão de Pessoal - DGP", "Diretoria de Ensino e Pesquisa - DEP", "Diretoria de Planejamento - DPLAN"],
      "cargos": []
    },
    "do-se-lob": {
      "name": "Órgãos de Direção Operacional", "abbreviation": "DO", "category": "Direção Operacional", "source": "lob",
      "subordinadoA": "Comandante-Geral / Subcomandante-Geral", "legalRef": "Art. 28 a 31",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 28 (Órgãos de Direção Operacional)", "Art. 29 (DAT)", "Art. 30 (DOP)", "Art. 31 (Diretor-Adjunto)"],
      "atribuicoes": [
        "Os Órgãos de Direção Operacional se destinam à gestão, planejamento, supervisão, coordenação, controle e fiscalização das missões finalísticas da Corporação, cuja chefia é privativa de oficiais da ativa do último posto do quadro QOBM e são assim constituídas: I - Diretoria de Atividades Técnicas - DAT; II - Diretoria Operacional - DOP (Art. 28). Cada Diretoria deve ter um Diretor-Adjunto, do Posto de Tenente-Coronel, para atuar como auxiliar direto do Diretor e substituí-lo em suas ausências (Art. 31)."
      ],
      "desdobramentos": ["Diretoria de Atividades Técnicas - DAT", "Diretoria Operacional - DOP"],
      "cargos": []
    },
    "apoio-se-lob": {
      "name": "Órgãos de Apoio", "abbreviation": "APOIO", "category": "Apoio", "source": "lob",
      "subordinadoA": "Órgãos de Direção", "legalRef": "Art. 32 e 33",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 32 (Órgãos de Apoio)", "Art. 33 (Departamentos)"],
      "atribuicoes": [
        "Os Órgãos de Apoio atendem às necessidades de pessoal, saúde, ensino, pesquisa, logística, gestão orçamentária e financeira, material e serviços de toda a Corporação, atuando em cumprimento das diretrizes e ordens dos Órgãos de Direção, e compreendem os departamentos, centros, seções e núcleos (Art. 32). Aos Departamentos compete a organização, sob a forma de sistemas, das atividades de logística, patrimônio, administração financeiro-contábil, pessoal e outras, de acordo com as necessidades da instituição (Art. 33). Parágrafo Único. A função de Chefe de Departamento é privativa de oficial superior dos Quadros de Oficiais do CBMSE."
      ],
      "desdobramentos": ["Departamentos", "Centros", "Seções", "Núcleos"],
      "cargos": []
    },
    "exec-se-lob": {
      "name": "Órgãos de Execução", "abbreviation": "EXEC", "category": "Execução", "source": "lob",
      "subordinadoA": "Órgãos de Direção", "legalRef": "Art. 34",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 34 (Órgãos de Execução)"],
      "atribuicoes": [
        "Os Órgãos de Execução realizam as atividades operacionais e de apoio, cumprindo as missões e as destinações do CBMSE, em conformidade com a legislação, diretrizes e ordens emanadas dos Órgãos de Direção, compreendem os Comandos Regionais e as Unidades/Grupamentos (Art. 34)."
      ],
      "desdobramentos": ["Comandos Regionais Bombeiro Militar", "Unidades/Grupamentos"],
      "cargos": []
    },
    "crbm-se-lob": {
      "name": "Comandos Regionais Bombeiro Militar", "abbreviation": "CRBM", "category": "Execução", "source": "lob",
      "subordinadoA": "Diretoria Operacional", "legalRef": "Art. 35",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 35 (Comandos Regionais)"],
      "atribuicoes": [
        "Os Comandos Regionais Bombeiro Militar - CRBM subordinam-se à DOP e são órgãos de supervisão, coordenação e planejamento operacional das unidades subordinadas (Art. 35). § 2º Os Comandos Regionais são órgãos de direção estratégica, chefiados por oficiais superiores do Quadro de Oficiais Bombeiro Militar - QOBM e são assim constituídos: I - Comando Regional Metropolitano - CRM; II - Comando Regional do Alto Sertão - CRAS; III - Comando Regional do Médio Sertão - CRMS; IV - Comando Regional do Centro Sul - CRCS; V - Comando Regional do Sul - CRS; VI - Comando Regional do Leste - CRL; VII - Comando Regional do Agreste - CRA; VIII - Comando Regional do Baixo São Francisco - CRBSF."
      ],
      "desdobramentos": ["Comando Regional Metropolitano - CRM", "Comando Regional do Alto Sertão - CRAS", "Comando Regional do Médio Sertão - CRMS", "Comando Regional do Centro Sul - CRCS", "Comando Regional do Sul - CRS", "Comando Regional do Leste - CRL", "Comando Regional do Agreste - CRA", "Comando Regional do Baixo São Francisco - CRBSF"],
      "cargos": []
    },
    "unid-se-lob": {
      "name": "Unidades (Grupamentos)", "abbreviation": "UNID", "category": "Execução", "source": "lob",
      "subordinadoA": "Comandos Regionais Bombeiro Militar / Diretoria Operacional", "legalRef": "Art. 36 a 39",
      "baseLegal": "Lei nº 8.979, de 03 de fevereiro de 2022 (Lei de Organização Básica)",
      "artigosDeOrigem": ["Art. 36 (Unidades)", "Art. 37 (Grupamentos Bombeiro Militar)", "Art. 38 e 39 (Grupamentos Especializados)"],
      "atribuicoes": [
        "As Unidades, também denominadas de Grupamentos, realizam a execução das atividades operacionais e de apoio da Corporação e compreendem: I - Unidades operacionais; II - Unidades especializadas (Art. 36). § 1º As Unidades ou Grupamentos Operacionais de uma mesma Área Integrada de Segurança Pública - AISP, subordinam-se aos respectivos Comandos Regionais e os Grupamentos Especializados à Diretoria Operacional.",
        "São Grupamentos Especializados do CBMSE: I - Grupamento de Busca e Salvamento - GBS; II - Grupamento de Operações Aéreas - GOA (Art. 39)."
      ],
      "desdobramentos": ["1º GBM — Aracaju (CRM)", "2º GBM — Estância (CRS)", "3º GBM — Itabaiana (CRA)", "4º GBM — Nossa Senhora do Socorro (CRM/CRL)", "5º GBM — Lagarto (CRCS)", "6º GBM — Propriá (CRBSF)", "7º GBM — Nossa Senhora da Glória (CRAS/CRMS)", "8º GBM — Barra dos Coqueiros (CRM)", "Grupamento de Busca e Salvamento - GBS", "Grupamento de Operações Aéreas - GOA"],
      "cargos": []
    }
  }
},
