        ...
        {   # Oficial de Dia — no lugar do bloco suprimido (se-art-32..38); entra após se-art-38
            ...
            'artigos': [
                ...
                _art(
                    ...
                    [
                        'I - presidir a passagem de serviço e participar das demais solenidades, formaturas e atos regulamentares previstos para o início e o término do serviço;',
                        ...
                        'III - orientar e fiscalizar os militares empregados nos serviços internos do quartel, inclusive nos de guarda e segurança do aquartelamento, quanto às suas atribuições e ao cumprimento das normas, ordens e determinações em vigor;',
                        'IV - realizar inspeções nas dependências do quartel, verificando as condições de conservação, limpeza, organização e segurança e adotando ou solicitando as providências necessárias diante das irregularidades constatadas;',
                        'V - certificar-se de que as dependências que devam permanecer fechadas estejam devidamente resguardadas, mantendo o controle das respectivas chaves nos termos das normas internas;',
                        'VI - providenciar, na forma regulamentar, a substituição dos militares que não comparecerem aos serviços internos para os quais estejam escalados;',
                        'VII - controlar, observadas as normas em vigor, a entrada, a saída e a permanência de pessoas e a entrada e a saída de viaturas no quartel;',
                        'VIII - registrar a entrada ou a saída de materiais do quartel fora do horário de expediente, não permitindo sua retirada sem a devida autorização;',
                        'IX - zelar pelos materiais, armamentos, instalações e demais bens que estejam sob sua responsabilidade durante o serviço;',
                        'X - receber autoridades civis e militares que compareçam ao quartel fora do horário de expediente, adotando as providências protocolares cabíveis;',
                        'XI - receber e encaminhar, fora do horário de expediente, documentos ou comunicações de caráter urgente, adotando as providências necessárias para que cheguem tempestivamente à autoridade competente;',
                        'XII - comunicar imediatamente à autoridade competente as ocorrências extraordinárias verificadas durante o serviço, especialmente as relacionadas à disciplina, à segurança, ao pessoal ou ao patrimônio, inclusive os acidentes envolvendo pessoal, viaturas, material ou patrimônio ocorridos no âmbito do quartel;',
                        'XIII - adotar as providências imediatas destinadas a sanar ou minimizar alterações verificadas no funcionamento interno do quartel, submetendo à autoridade competente aquelas que excedam sua atribuição;',
                        'XIV - registrar em Parte Diária, via Sistema Eletrônico de Informações - SEI, as ocorrências e alterações verificadas durante sua jornada de serviço;',
                        'XV - fiscalizar o cumprimento das prisões e detenções de natureza disciplinar executadas nas dependências do aquartelamento, zelando pela observância das determinações da autoridade competente, das condições de segurança e das normas aplicáveis;',
                        'XVI - diante de fato que, em tese, constitua crime militar, adotar as providências imediatas destinadas à preservação do local, dos elementos de informação e das provas e, nas hipóteses de flagrante, as que lhe competirem nos termos da legislação processual penal militar, comunicando imediatamente o fato à autoridade de polícia judiciária militar competente; e',
                        'XVII - cumprir e fazer cumprir as ordens e determinações dos escalões superiores relacionadas ao serviço.',
                    ],
                    _F_SERV, heading=_H_OD,
                    nota='Revisão de 16/09/2026 (Art. 62 da publicável): 24 incisos consolidados em 17 — fundidos III/V/VII, IV/XXI, X/XI, XV/XX e XXIII/XXIV; o antigo VI (zelar pela disciplina, segurança e ordem) saiu por repetir o § 1º do artigo anterior; o I passa a "presidir a passagem de serviço" (coerente com o capítulo da passagem de serviço) e o último inciso deixa de se limitar ao serviço interno. Incisos XV e XVI: conferir com a Corregedoria quanto ao regulamento disciplinar e ao CPPM.',
                ),
            ],
        },
...
DELIBERACOES_SEMELHANTES = [
    ...
    {
        'data': '2026-09-16',
        'dispositivos': ['servico-operacional/se-art-38-c2 (Art. 62 da minuta publicável)'],
        'assunto': 'Competências do Oficial de Dia: incoerências e duplicidades',
        'decisao': ('Redação consolidada em 17 incisos: fundidos os incisos sobre orientação/fiscalização dos serviços internos e da guarda, '
                    'inspeções e conservação das dependências, controle de acesso de pessoas e viaturas, comunicação de ocorrências e acidentes, '
                    'e providências em crime militar/flagrante; retirado o inciso que repetia o § 1º do artigo do regime (disciplina, segurança e ordem); '
                    '"presidir a passagem de serviço" no inciso I; o dever de cumprir ordens deixa de se limitar ao serviço interno. Artigo novo da versão atual; a consulta não muda.'),
    },
]
